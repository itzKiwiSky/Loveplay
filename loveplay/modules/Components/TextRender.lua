...
function TextRendererComponent:onDraw()
    local oldColor = { love.graphics.getColor() }
    love.graphics.setColor(self.color)
        love.graphics.printf(self.text, self.font, self.pos.x, self.pos.y, self.width, alignments[self.align])
        if self.shadow then
            love.graphics.setColor(self.shadowColor)
            love.graphics.printf(self.text, self.font, self.pos.x + self.shadowOffset.x, self.pos.y + self.shadowOffset.y, self.width, alignments[self.align])
        end
